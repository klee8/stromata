...
# --gcBias
#salmon quant -i transcriptome/Epichloe_elymi_trans_index -l U -r ../2_star_mapping/mappedfiles/INF1/E.elymi_Ee-Inf1_S14_L006_R1_001.fastq --validateMappings --gcBias -o trial_trim_files/Epichloe_elymi_INF1_quant
#salmon quant -i transcriptome/Epichloe_elymi_trans_index -l U -r ../2_star_mapping/mappedfiles/INF2/E.elymi_Ee-Inf2_S15_L006_R1_001.fastq --validateMappings --gcBias -o trial_trim_files/Epichloe_elymi_INF2_quant
#salmon quant -i transcriptome/Epichloe_elymi_trans_index -l U -r ../2_star_mapping/mappedfiles/PS1/E.elymi_Ee-PS1_S7_L007_R1_001.fastq --validateMappings --gcBias -o trial_trim_files/Epichloe_elymi_PS1_quant


#########  Alignment OPTION (takes in transcriptome fasta and bam files and does counts)
salmon quant -t transcriptome/Epichloe_elymi.transcripts.fa -l U -a ../2_star_mapping/mappedfiles/INF1/E.elymi_Ee-Inf1_S14_L006_R1_001_Aligned.toTranscriptome.out.bam --gcBias -o trial_trim_files/Epichloe_elymi_INF1_aln
salmon quant -t transcriptome/Epichloe_elymi.transcripts.fa -l U -a ../2_star_mapping/mappedfiles/INF2/E.elymi_Ee-Inf2_S15_L006_R1_001_Aligned.toTranscriptome.out.bam --gcBias -o trial_trim_files/Epichloe_elymi_INF2_aln
salmon quant -t transcriptome/Epichloe_elymi.transcripts.fa -l U -a ../2_star_mapping/mappedfiles/PS1/E.elymi_Ee-PS1_S7_L007_R1_001_Aligned.toTranscriptome.out.bam --gcBias -o trial_trim_files/Epichloe_elymi_PS1_aln
