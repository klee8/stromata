...
pdf("plots/STR_vs_PS_PCA_plot_rld-normalised_data.pdf", onefile = FALSE)
...
write.table(all_results, "result_tables/E.festucae_E2368_STR_PS.txt", quote = FALSE, row.names = FALSE, sep = "\t")
```
