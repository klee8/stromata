...
if (length(args)<1) {
  ...
  cluster_res_file = paste("cluster_perm_results/", args[1], "_cluster_results.txt", sep = "") 
  perm_res_file = paste("cluster_perm_results/", args[1], "_permuted_DE_cluster_results.txt", sep = "")
  sum_perm_file = paste("cluster_perm_results/", args[1], "_permuted_cluster_summary.txt", sep = "")
  graphout_file = paste("cluster_perm_results/", args[1], "_permuted_DE_clusters.pdf", sep = "")
  nsim = args[2] 
}

source(paste(scriptdir, args[3], sep = ""))
