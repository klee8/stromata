...
```{r get_data}
elymi <- read.delim("E.elymi_NfE728/result_tables/E.elymi_NfE728_STR_PS.txt", header = TRUE, blank.lines.skip = TRUE)
festucae <- read.delim("E.festucae_E2368/result_tables/E.festucae_E2368_STR_PS.txt", header = TRUE, blank.lines.skip = TRUE)
typhina <- read.delim("E.typhina_E8/result_tables/E.typhina_E8_STR_PS.txt", header = TRUE, blank.lines.skip = TRUE)
```
...
signalP <- read.delim("../SignalP/E.typhina_E8_signalP.txt", header = FALSE, blank.lines.skip = TRUE, fill = TRUE, sep = "\t", comment.char = "#")
colnames(signalP) <- c("gene_id", "Pr_signalP", "sigP_pos", "sigP_clev", "Pr_sigP_clev")
signalP$gene_id <- gsub("-T1", "", signalP$gene_id)
...
effectorP <- read.delim("../EffectorP/E.typhina_E8_effectorP.txt", header = TRUE, blank.lines.skip = TRUE, fill = TRUE, sep = "\t", comment.char = "#")
colnames(effectorP) <- c("gene_id", "effectorP", "efP_Pr")
effectorP$gene_id <- gsub("-T1.*", "", effectorP$gene_id)
...
pannzer <- read.delim("../Pannzer/E.typhina_E8/E.typhina_E8_pannzer_DE.txt", header = TRUE, comment.char = "#", blank.lines.skip = TRUE, fill = TRUE, sep = "\t")
pannzer$gene_id <- gsub("-T1", "", pannzer$qpid)
pan_keep <- pannzer[, c("gene_id", "desc", "genename")]
colnames(pan_keep) <- c("gene_id", "pannzer_desc", "pannzer_genename")
...
write.table(core_set_pann, "STR_PS/core_gene_set_STR_PS_pannzer.txt", quote = FALSE, row.names = FALSE, sep = "\t")
```
