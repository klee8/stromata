...
write.table(goi, "result_tables/E.typhina_E8_STR_PS.txt", quote = FALSE, row.names = FALSE, sep = "\t")
...
write.table(sub_2FC, "result_tables/E.typhina_E8_STR_PS_2FC.txt", quote = FALSE, row.names = FALSE, sep = "\t")
