...
core_set <- core_set[, c("orthogroup",   "num_spp", "m3", "elymi_gene_id",  "festucae_gene_id",   "elymi_apeglm_log2FC",  "elymi_apeglm_lfcSE", "elymi_apeglm_1_svalue",  "elymi_apeglm_2_svalue",  "elymi_mean_STR_TPM",  "elymi_mean_INF_TPM", "festucae_apeglm_log2FC", "festucae_apeglm_lfcSE",  "festucae_apeglm_1_svalue", "festucae_apeglm_2_svalue", "festucae_mean_STR_TPM", "festucae_mean_INF_TPM",  "core_up",                 "core_down",               "top_4FC_up",              "top_4FC_down",   "top_2FC_up",  "top_2FC_down",      "elymi_Feature", "elymi_Contig",  "elymi_Start",  "elymi_Stop", "elymi_Strand", "elymi_Name", "elymi_Product", "elymi_BUSCO", "elymi_PFAM",              "elymi_InterPro",          "elymi_EggNog",            "elymi_COG",     "elymi_GO.Terms",   "elymi_Secreted",  "elymi_Membrane",   "elymi_Protease",    "elymi_CAZyme",  "elymi_Notes",  "elymi_Translation",  "elymi_protein_length",  "festucae_Feature",        "festucae_Contig",         "festucae_Start",         "festucae_Stop",           "festucae_Strand",         "festucae_Name",           "festucae_Product",        "festucae_BUSCO",          "festucae_PFAM",          "festucae_InterPro",       "festucae_EggNog",         "festucae_COG",            "festucae_GO.Terms",       "festucae_Secreted",       "festucae_Membrane",      "festucae_Protease",       "festucae_CAZyme",         "festucae_Notes",             "festucae_Translation", "festucae_protein_length" ) ]
str(core_set)
...
#m3 <- read.delim(paste(resdir, "lookup_ortholog_groups.txt", sep = ""), header = TRUE, sep = "\t")
#m3 <- m3[, c("orthogroup", "m3")]
...
core_set_pann <- core_set_pann[, c( "orthogroup", "num_spp","m3", "elymi_gene_id", "festucae_gene_id", "elymi_apeglm_log2FC","elymi_apeglm_lfcSE", "elymi_apeglm_1_svalue","elymi_apeglm_2_svalue", "elymi_mean_STR_TPM", "elymi_mean_INF_TPM", "festucae_apeglm_log2FC", "festucae_apeglm_lfcSE", "festucae_apeglm_1_svalue", "festucae_apeglm_2_svalue","festucae_mean_STR_TPM","festucae_mean_INF_TPM", "core_up", "core_down","top_4FC_up", "top_4FC_down", "top_2FC_up","top_2FC_down", "el_Pr_signalP","el_sigP_pos","el_sigP_clev", "el_Pr_sigP_clev","fe_Pr_signalP", "fe_sigP_pos","fe_sigP_clev", "fe_Pr_sigP_clev", "el_effectorP","el_efP_Pr", "fe_effectorP","fe_efP_Pr", "el_pannzer_desc","el_pannzer_genename", "fe_pannzer_desc", "fe_pannzer_genename")]
