...
#keep <- c("gene_id","INF_fpkm", "PS_fpkm", "apeglm_log2FC", "apeglm_1_lfcSE",  "apeglm_1_svalue", "apeglm_log2FC", "apeglm_2_lfcSE", "apeglm_2_svalue")
...
#write.table(core_set_ann, "INF_PS/core_gene_set_INF_PS_ann.txt", quote = FALSE, row.names = FALSE, sep = "\t")
#write.table(core_set_trans,"INF_PS/core_gene_set_INF_PS_sequences.txt", quote = FALSE, row.names = FALSE, sep = "\t")
...
core_set_pann <- core_set[, c("orthogroup",   "num_spp", "m3",  "elymi_gene_id",       "festucae_gene_id",         "elymi_apeglm_log2FC",     "elymi_apeglm_lfcSE",   "elymi_apeglm_1_svalue",   "elymi_apeglm_2_svalue",   "elymi_mean_INF_TPM",       "elymi_mean_PS_TPM",      "festucae_apeglm_log2FC", "festucae_apeglm_lfcSE",  "festucae_apeglm_1_svalue", "festucae_apeglm_2_svalue", "festucae_mean_INF_TPM",    "festucae_mean_PS_TPM",  "core_up",  "core_down", "top_4FC_up", "top_4FC_down",   "top_2FC_up",  "top_2FC_down")]      
