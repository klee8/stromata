...
write.table(goi, "result_tables/E.festucae_E2368_STR_PS.txt", quote = FALSE, row.names = FALSE, sep = "\t")
...
sub_2FC <- all_results %>% select(gene_id, apeglm_log2FC, apeglm_lfcSE, apeglm_1_svalue, mean_PS_TPM, mean_STR_TPM, up_2FC, down_2FC)

write.table(sub_2FC, "result_tables/E.festucae_E2368_STR_PS_2FC.txt", quote = FALSE, row.names = FALSE, sep = "\t")
