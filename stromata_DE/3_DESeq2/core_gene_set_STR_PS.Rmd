...
elymi <- merge(elymi, orthology[, c("ortho_group", "spp", "gene_id")], by.x = "elymi_gene_id", by.y = "gene_id")
festucae <- merge(festucae, orthology[, c("ortho_group", "spp", "gene_id")], by.x = "festucae_gene_id", by.y = "gene_id")
typhina <- merge(typhina, orthology[, c("ortho_group", "spp", "gene_id")], by.x = "typhina_gene_id", by.y = "gene_id")

# elymi includes 96 rows with missing protein (e.g. tRNA) that didn't go through orthoprotein 
