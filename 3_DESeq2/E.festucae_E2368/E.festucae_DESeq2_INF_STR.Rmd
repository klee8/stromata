...
par(mfrow=c(2,3))
plotCounts(dds, gene="Efe2368_006222", intgroup="condition")
plotCounts(dds, gene="Efe2368_001395", intgroup="condition")
plotCounts(dds, gene="Efe2368_005069", intgroup="condition")
plotCounts(dds, gene="Efe2368_001066", intgroup="condition")
plotCounts(dds, gene="Efe2368_002007", intgroup="condition")
plotCounts(dds, gene="Efe2368_002122", intgroup="condition")
```
...
write.table(table, "E.festucae_INF_STR_log2foldchange.txt", quote = FALSE, row.names = FALSE, sep = "\t")
