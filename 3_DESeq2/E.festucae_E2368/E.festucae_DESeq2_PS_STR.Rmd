...
par(mfrow=c(2,3))
plotCounts(dds, gene="Efe2368_005491", intgroup="condition")
plotCounts(dds, gene="Efe2368_000822", intgroup="condition")
plotCounts(dds, gene="Efe2368_000585", intgroup="condition")
plotCounts(dds, gene="Efe2368_005561", intgroup="condition")
plotCounts(dds, gene="Efe2368_005571", intgroup="condition")
plotCounts(dds, gene="Efe2368_005038", intgroup="condition")
...
write.table(table, "E.festucae_PS_STR_log2foldchange.txt", quote = FALSE, row.names = FALSE, sep = "\t")
