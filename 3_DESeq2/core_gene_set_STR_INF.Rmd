...
keep <- c("gene_id","STR_fpkm", "INF_fpkm", "apeglm_1_log2FC", "apeglm_1_lfcSE",  "apeglm_1_svalue", "apeglm_2_log2FC", "apeglm_2_lfcSE", "apeglm_2_svalue")
elymi <- elymi[, keep]
...
str(elymi)
str(festucae)
#elymi[is.na(elymi$group),]
#festucae[is.na(festucae$group),]
```
