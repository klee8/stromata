...
par(mfrow=c(2,3))
plotCounts(dds, gene="Ety8_002326", intgroup="condition")
plotCounts(dds, gene="Ety8_003283", intgroup="condition")
plotCounts(dds, gene="Ety8_005714", intgroup="condition")
plotCounts(dds, gene="Ety8_006897", intgroup="condition")
plotCounts(dds, gene="Ety8_008124", intgroup="condition")
plotCounts(dds, gene="Ety8_005942", intgroup="condition")
...
write.table(table, "E.typhina_PS_STR_log2foldchange.txt", quote = FALSE, row.names = FALSE, sep = "\t")
