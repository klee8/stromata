...
par(mfrow=c(2,3))
plotCounts(dds, gene="FUN_002432", intgroup="condition")
plotCounts(dds, gene="FUN_006503", intgroup="condition")
plotCounts(dds, gene="FUN_003186", intgroup="condition")
plotCounts(dds, gene="FUN_003376", intgroup="condition")
plotCounts(dds, gene="FUN_003574", intgroup="condition")
plotCounts(dds, gene="FUN_000070", intgroup="condition")
...
write.table(table, "E.elymi_PS_INF_log2foldchange.txt", quote = FALSE, row.names = FALSE, sep = "\t")
