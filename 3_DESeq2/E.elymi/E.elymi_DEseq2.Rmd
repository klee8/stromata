...
par(mfrow=c(2,3))
plotCounts(dds, gene="FUN_000002", intgroup="condition")
plotCounts(dds, gene="FUN_000003", intgroup="condition")
plotCounts(dds, gene="FUN_000006", intgroup="condition")
plotCounts(dds, gene="FUN_000010", intgroup="condition")
plotCounts(dds, gene="FUN_000012", intgroup="condition")
plotCounts(dds, gene="FUN_000013", intgroup="condition")
