...
pdf("plots/STR_vs_INF_PCA_plot_rld-normalised_data.pdf", onefile = FALSE)
...
write.table(all_results, "result_tables/E.elymi_NfE728_STR_INF.txt", quote = FALSE, row.names = FALSE, sep = "\t")
```
